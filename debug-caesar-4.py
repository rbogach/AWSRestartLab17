...
def getCipherKey():
    ...
    while not shiftAmount.isnumeric():
        shiftAmount = input("Please enter a key (whole number from 1-25) AGAIINNN!!!!: ")
        #if not shiftAmount.isnumeric():
            #shiftAmount = input("Or U enter the key or I can iterate it till eternity!! ")
